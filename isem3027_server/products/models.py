...
#  in this function, will return a self-defined image path (rename to product name, easy to identify the products, instance, current product)
...
class Product(models.Model): # declare a model class
    ...
    # __str__ is used to present what is this product
    def __str__(self):
        return self.name

    class Meta:
        # ordering of all products by created time
        ordering = ["-created"]
